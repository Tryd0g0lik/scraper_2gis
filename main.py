...
if __name__ == "__main__":
  ...
  thema: str = return_rubric_name(['Морги', 'Кладбища', 'Церкви', 'Храмы', 'Соборы', 'Колумбарии', 'Крематории', 'Помощь в организации похорон',
     'Памятники надгробия',
     'Ритуальные услуги для животных'])  # "Крематории" # return_rubric_name(["кладбище", 'морг']) животные церкви Помощь в организации похорон
